...
import { idlFactory } from './minter_frontend.did.js';
export { idlFactory } from './minter_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MINTER_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./minter_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the minter_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./minter_frontend.did.js")._SERVICE>}
 */
export const minter_frontend = createActor(canisterId);
